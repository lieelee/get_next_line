...
<p><b><i>Reading a line on a fd is way too tedious
The ‘get_next_file.c’ returns one line at the time but the main function in the ‘main.c’ file is written to display all lines using a while loop until the end of file. </i</b> </p>
